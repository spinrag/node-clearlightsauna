...
const commitTypes = [
	...
	{ type: 'feature', section: '♨️ Features' },
	{ type: 'fix', section: '🧊 Bug Fixes' },
	{ type: 'hotfix', section: '🔥 Hot Fixes' },
	{ type: 'improvement', section: '🌡️ Improvements' },
	{ type: 'improve', section: '🌡️ Improvements' },
	{ type: 'test', section: '⚙️ Tests' },
	{ type: 'build', section: '⚙️ Build System' },
	{ type: 'ci', section: '⚙️ CICD' },
